                            ...
                            >
                                {plan.popular && (
                                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                        <Badge className="bg-gradient-to-r from-blue-600 to-blue-600 text-white px-4 py-1">
                ...
                <div className="max-w-4xl mx-auto">
                    <Card className="border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-blue-50">
                        <CardContent className="p-8 text-center">
                            <div className="h-16 w-16 bg-gradient-to-br from-blue-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                            ...
                            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                                Try WearePratik risk-free. If you're not completely satisfied within the first 30 days,
